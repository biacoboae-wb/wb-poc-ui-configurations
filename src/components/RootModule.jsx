...
export const mapDispatchToProps = (dispatch) => ({
  switchLanguage: async ({ target }) => {
    ...
    await dispatch(
      loadLanguagePack("root-module", { fallbackLocale: "en-US" }),
    );
  },
});
...
export const mapStateToProps = (state) => {
  ...
  const languagePack = state
    .getIn(["intl", "languagePacks", localeName, "root-module"], fromJS({}))
    .toJS();
...
export const loadModuleData = ({ store: { dispatch } }) =>
  dispatch(loadLanguagePack("root-module", { fallbackLocale: "en-US" }));
